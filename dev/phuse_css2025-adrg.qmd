...
Action: Also open and show example ADRG (preferably the one from PHUSE ADRG WG - 2019), Protocol, SAP/RAP, Clinical Study Report and Define.xml
...
::: notes
Open an example of ADRG (preferably the one from PHUSE ADRG WG - 2019) and highlight section where OS software related information is needed.
:::

...
-   Members of the PHUSE Communication of Version Metadata Working Group
    -   Joel Laxamana (Co-Lead : Roche/Genentech)
    -   Lovemore Gakava (Co-Lead : Novo Nordisk)
    -   Cervan Girard (Novo Nordisk)
    -   Eric Nantz (Eli Lilly)
    -   Nicholas Masel (Johnson & Johnson)
    -   Sam Parmar (Pfizer)
    -   Steven Haesendonckx (Johnson & Johnson)
    -   Piotr Pasza Storożenko (Appsilon)
    -   Collaborating with R Consortium Submissions WG and PHUSE Data Standards group
...
While documentation practices and reproducibility are well-established for proprietary software such as SAS, there is a need to establish consistent documentation standards and reproducibility in open-source (R, Python, etc.) statistical programming environments.
:::
...
::: incremental
-   The **objective** of this project is to develop a new template or enhance the existing Analysis Data Reviewer’s Guide (ADRG) for open-source submissions.
...
-   The **standardized template** will streamline the submission of clinical study to health authorities as part of the regulatory review process.
...
::: incremental
-   Transition from proprietary software (SAS) to open-source
-   Growing adoption of open-source langages (R, python...) in clinical trials
-   Need for standardized documentation that accommodates all paradigms
:::
...
:::: fragment
::: incremental
-   Objective: Contribute to the enhancement of the ADRG template for open-source submissions
-   Aim: Consistent metadata documentation
-   Benefits: Enhanced reproducibility & transparency
-   Evolution: Shift from proprietary to open-source in clinical trials
:::
::::
...
## Purpose of Analysis Data Reviewer’s Guide (ADRG) {.smaller}
...
-   Provides Regulatory reviewers with context for analysis datasets and terminology.
...
## ADRG Overview {.smaller}

::: fragment
The ADRG has seven required sections:
...
The ADRG also has two optional sections:

-   Appendix (for other documentation that would be helpful to a reviewer)

-   Legacy Data Conversion Plan & Report Appendix
:::
...
-   Show example of the ADRG template

-   The ADRG provides FDA reviewers with context for analysis datasets and terminology, received as part of a regulatory product submission, additional to what is presented within the data folder (i.e., define.xml). The ADRG also provides a summary of ADaM other submission documentation (e.g., the protocol, statistical analysis plan (SAP), clinical study report, define.xml) in order to provide FDA reviewers with a single point of orientation to the analysis datasets. It should be noted that the submission of an ADRG does not eliminate the requirement to submit a complete and informative define.xml file corresponding to the analysis datasets.

-   An ADRG for clinical data should be called an ADRG and the document should be a PDF file ‘adrg.pdf’ upon submission. source: \[STUDY DATA TECHNICAL CONFORMANCE GUIDE\] (https://www.fda.gov/media/162867/download)

-   ADRG_Completion_Guidelines_v1.2
...
https://advance.hub.phuse.global/wiki/x/tAGZAQ https://advance.hub.phuse.global/wiki/spaces/WEL/pages/26804660/Analysis+Data+Reviewer+s+Guide+ADRG+Package

For PROTOCOL, SAP, CSR - see page 8 of the document in folder references/sap-cdiscpilot01.pdf
:::

## From proprietary software to open-source language
...
## Proprietary Statistical Programming Software
...
::: incremental
-   Language and Packages Versions control complexities
...
-   Proprietary software: version info in SAP & ADRG
-   Open-source languages challenges: dependencies, control, reproducibility
:::
...
# III. Collaboration with RConsortium and PHUSE ADRG WG
...
::: incremental
-   Ongoing discussions with R Consortium Submissions WG
-   Collaboration with PHUSE Data Standards group
...
-   Gaps in existing ADRG template for R-specific metadata
    -   See the existing completion guideline
...
::: notes
- CG
- don't forget to talk about ADRG LLM current work
:::
...
-   R package development for sections in the ADRG
...
-   Core work:
    ...
    -   [Communication of Version Metadata for Open-Source Languages](https://advance.hub.phuse.global/wiki/spaces/WEL/pages/26804419/Data+Visualisation+Open+Source+Technology)
...
-   [Analysis Data Reviewer's Guide (ADRG) Package](https://advance.hub.phuse.global/wiki/spaces/WEL/pages/26804660/Analysis+Data+Reviewer+s+Guide+ADRG+Package)
...
-   [PMDA New Drug Review with Electronic Data](https://www.pmda.go.jp/english/review-services/reviews/0002.html)
-   [R Consortium R Submission Working Group](https://rconsortium.github.io/submissions-wg/)

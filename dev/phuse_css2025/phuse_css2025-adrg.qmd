...
While documentation practices and reproducibility are well-established for proprietary packages such as SAS, there is a need to establish consistent documentation standards and reproducibility in open-source (R, Python, etc.) statistical programming environments.
:::
...
-   Gaps in current ADRG template for R-specific metadata
    -   See the current complition guidline

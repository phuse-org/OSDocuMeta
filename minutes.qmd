...
**Attendees:** Sam Parmar, Eric Nantz\
**Guest(s):**\
**Facilitator:**
...
1.  R Analysis Data Reviewer's Guide Completion Guideline

    [R for Clinical Study Reports and Submission](https://r4csr.org/submission-package.html) - discuss chapter 14 and 15

2.  Christine to organize a meeting with all groups working on updating ADRG sections and also provide draft ADRG guideline

3.  Members uploading utility functions used to populate ADRG sections
